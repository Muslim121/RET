<?php // Example 01: functions.php
  ...
  $data = 'rew';   // Change as necessary
  $user = 'jim';   // Change as necessary
  $pass = '200921mus';     // Change as necessary
  $chrs = 'utf8mb4';
  ...
  function createTable($name, $query)
  {
    ...
    echo "'$name' создан или уже существует.<br>";
  }
  ...
  function showProfile($user)
  {
    ...
    echo "<p>Пока здесь, не на что смотреть</p><br>";
  }
