...
_INIT;
  ...
  if (isset($_SESSION['user']))
  {
    $user     = $_SESSION['user'];
    $loggedin = TRUE;
    $userstr  = "Вошел в аккаунт как: $user";
  }
  else $loggedin = FALSE;

echo <<<_MAIN
    <title> MyNest: $userstr</title>
  </head>
  <body>
    <div data-role='page'>
      <div data-role='header'>
        <div id='logo' class='center'>MyNest</div>
...
echo <<<_GUEST
        ...
        <p class='info'>(Вы должны войти в аккаунт, чтобы использовать это приложение)</p>
